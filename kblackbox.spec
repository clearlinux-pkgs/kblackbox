...
Version  : 24.05.1
Release  : 68
URL      : https://download.kde.org/stable/release-service/24.05.1/src/kblackbox-24.05.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/kblackbox-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/kblackbox-24.05.1.tar.xz.sig
...
%setup -q -n kblackbox-24.05.1
cd %{_builddir}/kblackbox-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718409305
mkdir -p clr-build
pushd clr-build
