...
Version  : 24.05.0
Release  : 66
URL      : https://download.kde.org/stable/release-service/24.05.0/src/kblackbox-24.05.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.0/src/kblackbox-24.05.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.0/src/kblackbox-24.05.0.tar.xz.sig
...
%setup -q -n kblackbox-24.05.0
cd %{_builddir}/kblackbox-24.05.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716529011
mkdir -p clr-build
pushd clr-build
