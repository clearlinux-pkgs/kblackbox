...
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/kblackbox-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/kblackbox-25.04.2.tar.xz.sig
...
%setup -q -n kblackbox-25.04.2
cd %{_builddir}/kblackbox-25.04.2
pushd ..
cp -a kblackbox-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749512278
mkdir -p clr-build
pushd clr-build
