...
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/kblackbox-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/kblackbox-24.12.3.tar.xz.sig
...
%setup -q -n kblackbox-24.12.3
cd %{_builddir}/kblackbox-24.12.3
pushd ..
cp -a kblackbox-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742469768
mkdir -p clr-build
pushd clr-build
