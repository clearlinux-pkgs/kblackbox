...
Version  : 22.12.3
Release  : 50
URL      : https://download.kde.org/stable/release-service/22.12.3/src/kblackbox-22.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/kblackbox-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/kblackbox-22.12.3.tar.xz.sig
...
%prep
%setup -q -n kblackbox-22.12.3
cd %{_builddir}/kblackbox-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677791417
mkdir -p clr-build
pushd clr-build
